...
namespace PettyCashPrototype.Controllers
{
    ...
    public class AccountSetsController : ControllerBase
    {
        ...
        [HttpGet, Route("index")]
        public async Task<ActionResult<IEnumerable<AccountSet>>> Index(string command)
        {
        ...
        public async Task<ActionResult<AccountSet>> Details(string command, int id)
        {
        ...
        [HttpPut, Route("edit")]
        public async Task<IActionResult> Edit([FromBody]AccountSet account)
        {
        ...
        public async Task<IActionResult> Delete([FromBody] AccountSet account)
        {
