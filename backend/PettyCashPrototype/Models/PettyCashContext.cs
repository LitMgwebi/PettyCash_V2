...
public partial class PettyCashContext : IdentityDbContext<User>
{
    public PettyCashContext()
    {
    }

    public PettyCashContext(DbContextOptions<PettyCashContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new AccountSetSeeding());
